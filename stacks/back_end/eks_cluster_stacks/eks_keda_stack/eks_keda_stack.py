...
class EksKedaStack(cdk.Stack):
    def __init__(
        ...
        clust_oidc_issuer,
        _events_processor_svc_accnt_role,
        **kwargs
    ) -> None:
        ...
        # Allow KEDA to assume SQS Consumer Role through Service Accounts
        self.keda_svc_accnt_role.add_to_policy(_iam.PolicyStatement(
            actions=[
                "sts:AssumeRole"
            ],
